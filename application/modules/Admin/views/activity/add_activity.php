      ...
      <?php echo form_open(base_url()."activities/add-activity"); ?>
        <div class="">
            <div class="form-group">
                ...
                <textarea class="textarea_editor form-control border-radius-0" name="activity_description" placeholder="Enter text ..." value="<?php echo set_value('activity_description')?>"></textarea>
            </div>
        </div>    
        <div class="">
